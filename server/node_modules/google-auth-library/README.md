...
=======
This is Google's officially supported [node.js](https://nodejs.org/) client library for using OAuth 2.0 authorization and authentication with Google APIs.
...
=======
            const qs = new url.URL(req.url, 'https://localhost:3000')
>>>>>>> ecca6d92d0de59a69b15d1aba40c775f6214643c
              .searchParams;
...
=======
"imdsv2_session_token_url": "https://169.254.169.254/latest/api/token"
>>>>>>> ecca6d92d0de59a69b15d1aba40c775f6214643c
