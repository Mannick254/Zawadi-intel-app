...
=======
         *   http.get('https://localhost:3000', { agent }, (res) => {
...
=======
         *     .get('https://localhost:3000', { agent }, (res) => {
>>>>>>> ecca6d92d0de59a69b15d1aba40c775f6214643c
         *       // ...
         *     })
         *     .on('error', (err) => {
...
=======
         * new URL(`https://${process.env.HOST ?? 'localhost'}${request.url}`);
>>>>>>> ecca6d92d0de59a69b15d1aba40c775f6214643c
         * ```
         *
...
=======
         * > new URL(`https://${process.env.HOST ?? 'localhost'}${request.url}`);
         * URL {
         *   href: 'https://localhost/status?name=ryan',
